...
#[repr(C)]
#[derive(Clone, Copy, Default)]
pub struct slipstream_path_probe_debug_t {
    pub reason_code: c_int,
    pub existing_path_id: c_int,
    pub partial_match_path_id: c_int,
    pub has_remote_cnxid_stash: c_int,
    pub is_multipath_enabled: c_int,
    pub migration_disabled_remote: c_int,
    pub migration_disabled_local: c_int,
    pub nb_paths: c_uint,
    pub path_target_limit: c_uint,
    pub max_path_id_local: u64,
    pub max_path_id_remote: u64,
    pub local_initial_max_path_id: u64,
    pub remote_initial_max_path_id: u64,
    pub remote_active_connection_id_limit: c_uint,
}
...
extern "C" {
    ...
    pub fn slipstream_get_path_target_limit() -> c_uint;
    pub fn slipstream_set_initial_max_path_id(quic: *mut picoquic_quic_t, initial_max_path_id: u64);
    pub fn slipstream_get_path_probe_debug(
        cnx: *mut picoquic_cnx_t,
        addr_peer: *const sockaddr,
        addr_local: *const sockaddr,
        debug: *mut slipstream_path_probe_debug_t,
    ) -> c_int;
