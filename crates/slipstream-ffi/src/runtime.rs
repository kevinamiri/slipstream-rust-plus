use crate::picoquic::{
    ...
    picoquic_stop_sending, slipstream_get_path_target_limit, slipstream_set_initial_max_path_id,
...
unsafe fn configure_quic_common(quic: *mut picoquic_quic_t, mtu: u32) {
    ...
    let path_target_limit = unsafe { slipstream_get_path_target_limit() } as u64;
    if path_target_limit > 0 {
        unsafe { slipstream_set_initial_max_path_id(quic, path_target_limit.saturating_sub(1)) };
    }
